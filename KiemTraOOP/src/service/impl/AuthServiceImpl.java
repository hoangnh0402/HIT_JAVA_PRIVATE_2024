...
public class AuthServiceImpl implements AuthService {
    ...
    public void login(Scanner scanner) {
        ...
        for (Account account : accounts) {
            if (account.getUsername().equals(username) && account.getPassword().equals(password) && account.getStatus() == Status.ACTIVE) {
    ...
    public void changePassword(String username, String oldPassword, String newPassword) {
        if (loggedInAccount != null && loggedInAccount.getUsername().equals(username)) {
            ...
            System.out.println("Không thể đổi mật khẩu. Bạn chưa đăng nhập hoặc không có quyền đổi mật khẩu tài khoản khác.");
        }
    }
}
